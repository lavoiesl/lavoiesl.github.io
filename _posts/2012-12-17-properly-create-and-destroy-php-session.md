...
However, it is important, for a useful usage of your shared cache, to only start a session when you really need it and destroy it when it is not needed anymore. PHP’s [session_start](http://php.net/session_destroy) specifically mentions that is does not unset the associated cookie.
...
{% endhighlight %}
[View Gist](https://gist.github.com/lavoiesl/4319721)
