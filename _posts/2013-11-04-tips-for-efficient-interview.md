---
title: "Tips for an efficient interview"
tags: ["Management", "Interview", "Symfony2"]
date: 2013-11-04 14:42:00 -0500
---
...
We recently made interviews where we tried a different approach. We let each candidate an hour to install and configure [Symfony](http://symfony.com/) with the idea of creating a micro blog platform. They start with a fully functional LAMP environment, but have to do all the rest. In their hour, they have to get the hang of [composer](http://getcomposer.org/), understand Symfony’s documentation, download all the dependencies, start a bundle, etc. We are giving them full Internet access because we want to test their ability to work in a real-world environment. The idea is not to test their speed or if they already know the technology, but more to see how they work individually.
