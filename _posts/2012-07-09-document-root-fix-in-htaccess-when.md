...
The RewriteBase has to be enabled if you are using a [VirtualDocumentRoot](http://httpd.apache.org/docs/2.0/mod/mod_vhost_alias.html#virtualdocumentroot) but when you are sharing code, developers may all have different setups.
...
{% endhighlight %}
[View Gist](https://gist.github.com/lavoiesl/2721888)
